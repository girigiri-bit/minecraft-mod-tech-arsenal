...
public class DroneEntity extends PathfinderMob implements RangedAttackMob
{
    ...
    {
        DroneBoltEntity bolt = new DroneBoltEntity(this.level(), this);
    ...
    {
        // Owner sneaking + empty hand: pick the drone back up
        if (player.isShiftKeyDown() && player.getItemInHand(hand).isEmpty() && player == getOwner())
        {
